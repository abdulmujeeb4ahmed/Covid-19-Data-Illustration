...
# Drops columns from the dataframe that aren't useful to us
...
# Calculates the mean, median, variance, and standard deviation for our desired columns
...
# Making a line plot with two lines representing the number of cases in Los Angeles County and the state of California over time
...
# Making a pie chart representing the proportion of new cases vs. new deaths in LA county
...
# Making a bar plot representing the number of new cases vs. new deaths in LA over time
...
# Making a scatter plot comparing the number of new deaths in Los Angeles with the number of new deaths in California over time
fig = plt.figure(figsize=(20, 10))
ax = fig.add_subplot(111)
x = df['date']
y1 = df['new_deaths']
